...
public class SpaceInvaders extends JPanel implements ActionListener, KeyListener {
    ...
    SpaceInvaders() {
        ...
        shipImg = new ImageIcon("E:/Games/Space Invaders Mario Edition/Space Invaders Mario/src/img3/mario4.png").getImage();
        alienImg = new ImageIcon("E:/Games/Space Invaders Mario Edition/Space Invaders Mario/src/img3/browser4.png").getImage();
        alienCyanImg = new ImageIcon("E:/Games/Space Invaders Mario Edition/Space Invaders Mario/src/img3/kong4.png").getImage();
        alienMagentaImg = new ImageIcon("E:/Games/Space Invaders Mario Edition/Space Invaders Mario/src/img3/goomba4.png").getImage();
        alienYellowImg = new ImageIcon("E:/Games/Space Invaders Mario Edition/Space Invaders Mario/src/img3/luigi4.png").getImage();
